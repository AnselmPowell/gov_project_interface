...
export default function PlaygroundSectionB() {
    ...
    <div className="w-full min-h-[95vh] flex flex-col">
      ...
      <section className="w-full h-[95vh] border-2 border-gray-200 p-4">
        <div className="h-full rounded-lg bg-gray-50 p-4">
          <h2 className="text-xl font-semibold mb-4">Playground 2A</h2>
      ...
      <section className="w-full h-[95vh] border-2 border-gray-200 p-4">
        <div className="h-full rounded-lg bg-gray-50 p-4">
          <h2 className="text-xl font-semibold mb-4">Playground 2B</h2>
          <div className="h-[calc(100%-2rem)]">
            <div className="flex h-full">
              <div 
                style={{ width: `${splitB}%` }} 

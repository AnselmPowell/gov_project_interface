...
//   return (
//     <div className="sw-card p-6 max-w-4xl mx-auto">
//       <h2 className="sw-heading-primary sw-text-blue mb-4">
...
//       >
//         <input {...getInputProps()} />
//         <Upload size={40} className={`mx-auto ${isDragActive ? 'sw-text-blue' : 'text-tertiary'}`} />
...
//               <li key={index} className="flex items-center p-3 bg-light-grey rounded-md">
//                 <File size={20} className="text-tertiary mr-3 flex-shrink-0" />
...
//                   className="sw-input p-2 text-sm mr-3 bg-white"
//                 >
...
//                   className="p-1 text-tertiary hover:sw-text-red focus:outline-none"
//                 >
//                   <X size={18} />
//                 </button>
//               </li>
